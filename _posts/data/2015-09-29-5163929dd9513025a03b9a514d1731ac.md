...
## 
[Yet Another PhD to Data Science Post (Part II)](http://blog.ethanrosenthal.com/2015/09/29/insight-to-interviews)


Welcome to Part II of my journey from academic to industry data scientist. In my previous [post](http://blog.ethanrosenthal.com/2015/09/23/start-to-insight), I wrote of my preparation leading up to the application to [Insight Data Science](http://www.insightdatascience.com/.). I will now talk about the Insight application process, the actual program, and demoing my project at companies. I will save studying for interviews and the actual interview process for the final [post](http://blog.ethanrosenthal.com/2015/10/06/interviews-to-job).
...
I approached my project hoping to use data to train a conventional classification or regression problem so that I could demonstrate knowledge of machine learning and get more experience with [scikit-learn](http://scikit-learn.org/). And so, I scraped all profiles for NYC academic tutors off of the website [WyzAnt](https://www.wyzant.com/). The idea was that I would build a model to predict how much a tutor should charge. A user would be able to input their WyzAnt profile, and I would tell them if they were charging too much or too little.
...
Here is a link to the finished project, [TutorWorthy](http://tutorworthy.ethanrosenthal.com/). Unfortunately, WyzAnt changed something about their website which broke my scraper. Because my website would scrape in real time, it does not work anymore. However, you can click the slides tab to see my "pitch deck".
...
In between demoing and frantically checking email to see if any companies got back to us, we studied for interviews. But I'll talk about that [next](http://blog.ethanrosenthal.com/2015/10/06/interviews-to-job) time
