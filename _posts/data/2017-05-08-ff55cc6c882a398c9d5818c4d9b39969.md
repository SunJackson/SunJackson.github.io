...
Last week, Cloudera [announced the General Availability release](https://www.cloudera.com/more/news-and-events/press-releases/2017-05-01-cloudera-announces-general-availability-of-data-science-workbench-to-accelerate-data-science-and-machine-learning-in-the-enterprise.html) of [Cloudera Data Science Workbench](https://www.cloudera.com/products/data-science-and-engineering/data-science-workbench.html). In this post, I’ll give a brief overview of its capabilities and architecture, along with a quick-start guide to connecting Cloudera Data Science Workbench to your existing CDH cluster in three simple steps.
...
You can download the official 1.0 RPM by visiting our [downloads page](https://www.cloudera.com/downloads/workbench/1-0.html) and then follow [a few simple installation steps](https://www.cloudera.com/documentation/data-science-workbench/latest/topics/cdsw_install.html).   At a high level, all you’ll need to do is:

1. [Configure gateway host in Cloudera Manager](https://www.cloudera.com/documentation/data-science-workbench/latest/topics/cdsw_install.html#configure_edge_hosts).

1. [Install Cloudera Data Science Workbench on the master gateway host](https://www.cloudera.com/documentation/data-science-workbench/latest/topics/cdsw_install.html#install_on_master).

1. [Add zero or more worker hosts](https://www.cloudera.com/documentation/data-science-workbench/latest/topics/cdsw_install.html#install_on_workers), if desired.
...
To learn more about Cloudera Data Science Workbench’s capabilities you can read the [product overview](https://www.cloudera.com/products/data-science-and-engineering/data-science-workbench.html) or watch a [webinar overview and demo](https://www.cloudera.com/content/dam/www/marketing/resources/webinars/introducing-cloudera-data-science-workbench-part1-recorded-webinar.png.landing.html) with Matt Brandwein, Director of Products at Cloudera.  If you have questions, please join the discussion on the [Cloudera Community](http://community.cloudera.com/t5/Cloudera-Data-Science-Workbench/bd-p/CDSW) portal.
