...
I’ve written a little about grazing before (How to calculate the [optimal dimensions](http://datagenetics.com/blog/march12016/index.html) for a rectangular field using just straight fences).
...
The rope constrains the goat into the *lens* shape bouded by two circular arcs; the lighter green in the diagram above. The complementry part of the field, that the goat cannot access, is give the name of a [lune](https://en.wikipedia.org/wiki/Lune_(geometry)) in reference to it's shape like the crescent of the Moon (The Latin word for 'Moon' is 'Luna').
...
This is not an amazingly pleasing or elegant answer; to be honest, I was expecting a cleaner answer, oh well. It is best solved numerically (using something like [Newton-Raphson](https://en.wikipedia.org/wiki/Newton), or in my case, the Goal-Seek function in Excel!)
...
These asymetric [circle-circle intersection](http://mathworld.wolfram.com/Circle-CircleIntersection.html) problems are interesting to investigate. If a cirlce of radius *r*, overlaps a circle of radius *R*, and the centers of the circle are *d* apart, then the equation for the overlapping lens is:
