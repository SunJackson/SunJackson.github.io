...
There are many ways to grab Open Street Map (OSM) data, since it’s, well, open. I grabbed the DC map from GeoFabrik [here](http://download.geofabrik.de/north-america/us/district-of-columbia.html).
