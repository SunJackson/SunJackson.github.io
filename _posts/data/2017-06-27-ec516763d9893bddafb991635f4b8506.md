...
**[Launch](https://console.aws.amazon.com/cloudformation/home#/stacks/new?stackName=Docker&templateURL=https://editions-us-east-1.s3.amazonaws.com/aws/stable/Docker.tmpl) Stack on AWS (Costs Money!)**
...
1. github [link](https://github.com/jupyter/docker-stacks/tree/master/datascience-notebook), dockerhub [link](https://hub.docker.com/r/jupyter/datascience-notebook)
...
1. [Deploy](https://docs.docker.com/docker-for-aws/deploy) your app
...
1. Videos at [vimeo](https://vimeo.com/channels/qlnotebooks), blog w/[ex](http://gouthamanbalaraman.com/blog/quantlib-python-tutorials-with-examples.html), [book](https://leanpub.com/quantlibpythoncookbook)


1. ipython [docker image](https://github.com/ruippeixotog/docker-qstk)

1. ontouchstart [docker image](https://hub.docker.com/r/ontouchstart/qstk)

1. Twisted logic [docker image](https://hub.docker.com/r/twistedogic/qstk)


1. Torch/iTorch/Ubuntu 14.04 Docker [image](https://registry.hub.docker.com/u/kaixhin/torch): docker pull kaixhin/torch

1. Torch/iTorch/CUDA 7/Ubuntu 14.04 Docker [image](https://registry.hub.docker.com/u/kaixhin/cuda-torch): docker pull kaixhin/cuda-torch
...
1. [Website](https://cocalc.com/.), [Pricing](https://cocalc.com/policies/pricing.html), [Wikipedia](https://en.wikipedia.org/wiki/CoCalc), [Chrome Extension](https://chrome.google.com/webstore/detail/the-sagemath-cloud/eocdndagganmilahaiclppjigemcinmb), [GitHub](https://github.com/sagemathinc/cocalc)

1. Or [Run your own CoCalc](https://github.com/sagemathinc/cocalc/blob/master/src/dev/docker) using their [Docker image](https://github.com/sagemathinc/cocalc/blob/master/src/dev/docker/README.md)
