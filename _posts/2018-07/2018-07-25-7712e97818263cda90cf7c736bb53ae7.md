...
As an introductory example, we explore how [aligned interpolation neuron visualizations](https://distill.pub/2017/feature-visualization#interpolation) are created.
...
![](https://distill.pub/2018/images/diagrams/styletransfer.png)
...
## [Generation of Semi-Transparent Patterns](https://distill.pub/2018/differentiable-parameterizations#section-rgba)
 ...
 To be concrete, let’s consider the case of semi-transparent images. These images have, in addition to the RGB channels, an alpha channel that encodes each pixel’s opacity (in the range [0,1][ gamma-corrected blending](https://en.wikipedia.org/wiki/Alpha_compositing#Composing_alpha_blending_with_gamma_correction) 
...
![](https://distill.pub/2018/images/diagrams/transparency.svg)
...
### Acknowledgments
 ...
 Dominik Roblek made the [3D printed example](https://distill.pub/2018/figure-style-transfer-3d-picture) possible, while Amit Patel hunted down an obscure bug in our [Style Transfer diagram](https://distill.pub/2018/figure-style-transfer-diagram).
 ...
 In particular, all of our experiments were based on [Tensorflow](https://www.tensorflow.org/),
 most of our interactive diagrams are built in [Svelte](https://svelte.technology/),
 and all 3D diagrams use [ThreeJS](https://threejs.org/).
...
[Review 1 - Pang Wei Koh](https://github.com/distillpub/post--differentiable-parameterizations/issues/50)[Review 2 - Anonymous](https://github.com/distillpub/post--differentiable-parameterizations/issues/51)[Review 3 - Anonymous](https://github.com/distillpub/post--differentiable-parameterizations/issues/52)

### References
1. Inceptionism: Going deeper into neural networks  [[HTML]](https://research.googleblog.com/2015/06/inceptionism-going-deeper-into-neural.html)Mordvintsev, A., Olah, C. and Tyka, M., 2015. Google Research Blog. Retrieved June, Vol 20(14), pp. 5. 
1. A Neural Algorithm of Artistic Style  [[PDF]](http://arxiv.org/pdf/1508.06576.pdf)Gatys, L.A., Ecker, A.S. and Bethge, M., 2015. CoRR, Vol abs/1508.06576. 
...
1. Deep neural networks are easily fooled: High confidence predictions for unrecognizable images  [[PDF]](http://arxiv.org/pdf/1412.1897.pdf)Nguyen, A.M., Yosinski, J. and Clune, J., 2015. IEEE Conference on Computer Vision and Pattern Recognition, CVPR 2015, Boston, MA, USA, June 7-12, 2015, pp. 427--436. 
1. Synthesizing robust adversarial examples  [[PDF]](https://arxiv.org/pdf/1707.07397.pdf)Athalye, A., Engstrom, L., Ilyas, A. and Kwok, K., 2017. arXiv preprint arXiv:1707.07397. 
1. The loss surfaces of multilayer networks  [[PDF]](http://arxiv.org/pdf/1412.0233.pdf)Choromanska, A., Henaff, M., Mathieu, M., Arous, G.B. and LeCun, Y., 2015. Artificial Intelligence and Statistics, pp. 192--204. 
1. Very deep convolutional networks for large-scale image recognition  [[PDF]](http://arxiv.org/pdf/1409.1556.pdf)Simonyan, K. and Zisserman, A., 2014. arXiv preprint arXiv:1409.1556. 
1. Deconvolution and checkerboard artifacts  [[link]](http://distill.pub/2016/deconv-checkerboard)Odena, A., Dumoulin, V. and Olah, C., 2016. Distill, Vol 1(10), pp. e3. [DOI: 10.23915/distill.00003](https://doi.org/10.23915/distill.00003)
1. Deep Image Prior  [[PDF]](http://arxiv.org/pdf/1711.10925.pdf)Ulyanov, D., Vedaldi, A. and Lempitsky, V.S., 2017. CoRR, Vol abs/1711.10925. 
1. Compositional pattern producing networks: A novel abstraction of development  [[PDF]](http://eplex.cs.ucf.edu/papers/stanley_gpem07.pdf)Stanley, K.O., 2007. Genetic programming and evolvable machines, Vol 8(2), pp. 131--162. Springer.
1. Neural Network Generative Art in Javascript  [[link]](http://blog.otoro.net/2015/06/19/neural-network-generative-art)Ha, D., 2015. 
1. Image Regression  [[HTML]](https://cs.stanford.edu/people/karpathy/convnetjs/demo/image_regression.html)Karpathy, A., 2014. 
1. Generating Large Images from Latent Vectors  [[link]](http://blog.otoro.net/2016/04/01/generating-large-images-from-latent-vectors)Ha, D., 2016. 
1. Artificial Evolution for Computer Graphics  [[HTML]](http://www.karlsims.com/papers/siggraph91.html)Sims, K., 1991. SIGGRAPH Comput. Graph., Vol 25(4), pp. 319--328. ACM. [DOI: 10.1145/127719.122752](https://doi.org/10.1145/127719.122752)
1. Neural 3D Mesh Renderer  [[PDF]](http://arxiv.org/pdf/1711.07566.pdf)Kato, H., Ushiku, Y. and Harada, T., 2017. arXiv preprint arXiv:1711.07566. 
1. The Stanford Bunny  [[link]](http://graphics. stanford. edu/data/3Dscanrep)Turk, G. and Levoy, M., 2005. Stanford University Computer Graphics Laboratory.
1. Natural evolution strategies.  [[PDF]](http://www.jmlr.org/papers/volume15/wierstra14a/wierstra14a.pdf)Wierstra, D., Schaul, T., Glasmachers, T., Sun, Y., Peters, J. and Schmidhuber, J., 2014. Journal of Machine Learning Research, Vol 15(1), pp. 949--980. 
...
### Updates and Corrections
 ...
 If you see mistakes or want to suggest changes, please [create an issue on GitHub](https://github.com/distillpub/post--differentiable-parameterizations/issues/new). 
### Reuse
Diagrams and text are licensed under Creative Commons Attribution [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0) with the [source available on GitHub](https://github.com/distillpub/post--differentiable-parameterizations), unless noted otherwise. The figures that have been reused from other sources don’t fall under this license and can be recognized by a note in their caption: “Figure from …”.
### Citation
