...
subtitle:   转载自：http://yerevann.github.io//2015/10/11/spoken-language-identification-with-deep-convolutional-networks/
date:       2018-07-19
author:     未知
...
I took the network architecture designed for the Kaggle’s [diabetic retinopathy detection contest](http://yerevann.github.io/2015/08/17/diabetic-retinopathy-detection-contest-what-we-did-wrong). 
...
The most important weakness of our team in the [previous contest](http://yerevann.github.io/2015/08/17/diabetic-retinopathy-detection-contest-what-we-did-wrong)
...
Maybe larger convolutional networks, like *OxfordNet* will perform better. 
