...
Shortly after we announced the [formation of Apache Arrow](https://blogs.apache.org/foundation/entry/the_apache_software_foundation_announces87) in February 2016,
[Hadley Wickham](http://hadley.nz/) and I met up and discussed how we could foster more
...
with just enough [file metadata](http://wesmckinney.com/blog/feather-its-the-metadata) to support the major Python and R data
types. We released this as the [Feather project](https://blog.cloudera.com/blog/2016/03/feather-a-fast-on-disk-format-for-data-frames-for-r-and-python-powered-by-apache-arrow). The implementation was
...
on the Feather 0.3.1 codebase from the [wesm/feather](https://github.com/wesm/feather) repository. Once that
