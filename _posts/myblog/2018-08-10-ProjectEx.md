...
### CBOW 和 skip-gram 对比？为什么 skip-gram + negative sampling 效果好？
...
- PageRank
    ...
    <img src="https://latex.codecogs.com/png.latex?$$S(V_i)=(1-d)+d\cdot\sum_{j\in In(V_i)}\frac{1}{|Out(V_j)|}S(V_j)$$" title="PageRank" />
...
- TextRank
    ...
    <img src="https://latex.codecogs.com/png.latex?$$WS(V_i)=(1-d)+d\cdot\sum_{V_j\in In(Vi)}\frac{w_{ji}}{\sum_{V_k\in Out(V_j)}w_{jk}}WS(V_j)$$" title="TextRank" />
