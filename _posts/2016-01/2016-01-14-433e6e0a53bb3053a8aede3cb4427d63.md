...
Image: [Konstantin Lanzet](https://commons.wikimedia.org/wiki/File:KL_Hercules_HGC.jpg)
...
Finally, there is a proverbial [collection of problems](https://en.wikipedia.org/wiki/Balance_puzzle) about finding counterfeit gold coins, in the minimum number of weighings, using just a balance beam and placing coins on each side. Sometimes the counterfeit coins are heavier, sometimes they are lighter, sometimes you aren't told either way; it depends on the problem. Sometimes there is more than one counterfeit coin. There are entire books written about these balance problems. 
