...
subtitle:      转载自：http://feedproxy.google.com/~r/RBloggers/~3/_u4-VjA2gsA/
date:      2018-11-19
...
```
![](http:kieranhealy.org/files/misc/df_chr_col.png)

![](http://feedproxy.google.com/~r/RBloggers/~3/_u4-VjA2gsA/kieranhealy.org/files/misc/df_chr_col.png)
...
```
![](http:kieranhealy.org/files/misc/df_chr_line.png)

![](http://feedproxy.google.com/~r/RBloggers/~3/_u4-VjA2gsA/kieranhealy.org/files/misc/df_chr_line.png)
...
```
![](http:kieranhealy.org/files/misc/df_fac_line.png)

![](http://feedproxy.google.com/~r/RBloggers/~3/_u4-VjA2gsA/kieranhealy.org/files/misc/df_fac_line.png)
...
```
![](http:kieranhealy.org/files/misc/df_chr_line_2.png)

![](http://feedproxy.google.com/~r/RBloggers/~3/_u4-VjA2gsA/kieranhealy.org/files/misc/df_chr_line_2.png)
