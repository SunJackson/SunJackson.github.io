...
In the last article, I wrote about [Voronoi Tessellations](http://datagenetics.com/blog/may12017/index.html).

In that article, for my examples, I used randomly generated points. This week, I searched the web looking for some real data that I could apply this technique to and came upon this [excellent data set](https://datahub.io/dataset/magglingen2013) - positional data from a professional soccer game. With a sampling frequency of 10Hz, coordinates for each of the 22 players (and the football) were recorded. It’s a wonderful dataset, and fun to play with.
...
Download the data from [here](https://datahub.io/dataset/magglingen2013).
