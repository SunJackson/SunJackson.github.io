...
- Created something **extensible:** if we want more precision around our answer, we simply simulate more and tabulate new results.[2]
...
1. If you wanted to estimate the value of Ï€, you could do it with a one-by-one square, a circle inscribed within that square, and a uniform random number generator.

1. Monte Carlo simulations are often employed to program AI for various popular games..

1. If you happen to be an asset manager and want to understand how different portfolio allocations generate returns in various environments, a tool like this one may be for you.

1. There are shelves of textbooks devoted to simulation methods in the physical sciences, including but not limited to physics,fluid dynamics, quantum mechanics, and biology.
